const CACHE='personal-tracker-v5.6.11';
const ASSETS=['./','./index.html','./config.js','./app.js','./polish.js','./backup.js','./ux-5.6.3.js','./ui-5.6.4.js','./tracker-ux-5.6.8.js','./manifest.json','./icon.svg'];
